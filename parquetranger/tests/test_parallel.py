...
from parquetranger.parallel import dask_para, try_client


@pytest.mark.parametrize(
    ["batches", "rowcount", "max_records", "group_cols"],
    product([5, 10, 50], [100, 1000, 10_000], [0, 90, 900], [None, "C"]),
)
def test_para_extend(tmp_path, batches, rowcount, max_records, group_cols):
